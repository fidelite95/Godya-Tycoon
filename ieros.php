...
<body>
  <div class="container">
    ...
    <div class="tycoon-container-mobile">
      <div class="tycoon-row">
        <?php
        $query = "SELECT * FROM tb_tycoon_ieros ORDER BY idx LIMIT 0, 5";
        $result = $con->query($query);
      ...
      <div class="tycoon-row">
        <?php
        $query = "SELECT * FROM tb_tycoon_ieros ORDER BY idx LIMIT 5, 6";
        $result = $con->query($query);
      ...
      <div class="tycoon-row">
        <?php
        $query = "SELECT * FROM tb_tycoon_ieros ORDER BY idx LIMIT 11, 5";
        $result = $con->query($query);
      ...
      <div class="tycoon-row">
        <?php
        $query = "SELECT * FROM tb_tycoon_ieros ORDER BY idx LIMIT 16, 6";
        $result = $con->query($query);
      ...
      <div class="tycoon-row">
        <?php
        $query = "SELECT * FROM tb_tycoon_ieros ORDER BY idx LIMIT 22, 5";
        $result = $con->query($query);
      ...
      <div class="tycoon-row">
        <?php
        $query = "SELECT * FROM tb_tycoon_ieros ORDER BY idx LIMIT 27, 6";
        $result = $con->query($query);
      ...
      <div class="tycoon-row">
        <?php
        $query = "SELECT * FROM tb_tycoon_ieros ORDER BY idx LIMIT 33, 5";
        $result = $con->query($query);
      ...
      <div class="tycoon-row">
        <?php
        $query = "SELECT * FROM tb_tycoon_ieros ORDER BY idx LIMIT 38, 6";
        $result = $con->query($query);
      ...
      <div class="tycoon-row">
        <?php
        $query = "SELECT * FROM tb_tycoon_ieros ORDER BY idx LIMIT 44, 5";
        $result = $con->query($query);
      ...
      <div class="tycoon-row">
        <?php
        $query = "SELECT * FROM tb_tycoon_ieros ORDER BY idx LIMIT 49, 6";
        $result = $con->query($query);
