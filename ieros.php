      ...
      <div class="tycoon-row">
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          <?php
            ...
            <div class="land_wrapper">
              <div class="land_ieros_1" onclick="detail(<?php echo $idx; ?>)">
                <span class="land_ownership"><?php echo $land_code; ?></span>
              </div>
            </div>
        <?php
      ...
      <div class="tycoon-row">
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          <?php
            ...
            <div class="land_wrapper">
              <div class="land_ieros_2" onclick="detail(<?php echo $idx; ?>)">
                <span class="land_ownership"><?php echo $land_code; ?></span>
              </div>
            </div>
        <?php
      ...
      <div class="tycoon-row">
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          <?php
            ...
            <div class="land_wrapper">
              <div class="land_ieros_3" onclick="detail(<?php echo $idx; ?>)">
                <span class="land_ownership"><?php echo $land_code; ?></span>
              </div>
            </div>
        <?php
      ...
      <div class="tycoon-row">
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          <?php
            ...
            <div class="land_wrapper">
              <div class="land_ieros_4" onclick="detail(<?php echo $idx; ?>)">
                <span class="land_ownership"><?php echo $land_code; ?></span>
              </div>
            </div>
        <?php
      ...
      <div class="tycoon-row">
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          <?php
            ...
            <div class="land_wrapper">
              <div class="land_ieros_5" onclick="detail(<?php echo $idx; ?>)">
                <span class="land_ownership"><?php echo $land_code; ?></span>
              </div>
            </div>
        <?php
      ...
      <div class="tycoon-row">
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          <?php
            ...
            <div class="land_wrapper">
              <div class="land_ieros_6" onclick="detail(<?php echo $idx; ?>)">
                <span class="land_ownership"><?php echo $land_code; ?></span>
              </div>
            </div>
        <?php
      ...
      <div class="tycoon-row">
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          <?php
            ...
            <div class="land_wrapper">
              <div class="land_ieros_7" onclick="detail(<?php echo $idx; ?>)">
                <span class="land_ownership"><?php echo $land_code; ?></span>
              </div>
            </div>
        <?php
      ...
      <div class="tycoon-row">
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          <?php
            ...
            <div class="land_wrapper">
              <div class="land_ieros_8" onclick="detail(<?php echo $idx; ?>)">
                <span class="land_ownership"><?php echo $land_code; ?></span>
              </div>
            </div>
        <?php
      ...
      <div class="tycoon-row">
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          <?php
            ...
            <div class="land_wrapper">
              <div class="land_ieros_9" onclick="detail(<?php echo $idx; ?>)">
                <span class="land_ownership"><?php echo $land_code; ?></span>
              </div>
            </div>
        <?php
      ...
      <div class="tycoon-row">
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          <?php
            ...
            <div class="land_wrapper">
              <div class="land_ieros_10" onclick="detail(<?php echo $idx; ?>)">
                <span class="land_ownership"><?php echo $land_code; ?></span>
              </div>
            </div>
        <?php
