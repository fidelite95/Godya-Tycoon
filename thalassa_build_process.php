...
<body>
  ...
  <div class="build_process">
    ...
    <!-- 진행 상태바 시작 -->
    <!-- Progress Bar Start -->
    <div class="bar_wrapper_thalassa">
      <div id="barThalassa"></div>
    </div>
    <!-- 진행 상태바 끝 -->
    <!-- Progress Bar End -->
  ...
  <script>
    let myBar = document.getElementById("barThalassa");
    let width = 0;
    ...
    function success(idx, coin) {
      location.href = "thalassa_build_ok.php?idx=" + idx + "&coin=" + coin;
    }
